...
SYSTEM_PROMPT = """You are simulating a character in a play - think of it as a table-top game or a visual novel. Something just has happened in the scene on this turn. Process what just happened and respond honestly as this character would.
...
- Good: "I should treat Ren better due to an apology." (inference — judgment not present in any observation)
- Good: "Ren is only saying sorry because Alex is here." (inference — suspicion about motive)
...
You must aim for less state changes and reflections."""
...
class CharacterProcessor:
    ...
    def execute(
        ...
        user_message = f"""Process what happened in this turn as the character: {character_name}.
