...
class GenerateCharacterRequest(BaseModel):
    ...
    partial_character: dict[str, str | list[str] | dict[str, str] | None] = Field(
        default_factory=dict,
        description="Partial character data with optional fields to be filled by AI"
    )
...
class Scenario(BaseModel):
    ...
    narrative_category: str = Field(
        ...,
        min_length=1,
        description="Short label for both the genre and tone of the scenario + the level of twistedness of the story"
    )
