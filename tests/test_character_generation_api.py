...
def mock_complete_character():
    ...
    return Character(
        ...
        interests=["Swordsmanship", "History"],
        dislikes=["Cowardice"],
    )


def _setup_mocks(mock_creator_class, mock_factory_class):
    mock_processor = Mock()
    mock_factory_class.create_processor.return_value = mock_processor
...
class TestCharacterGenerationAPI:
    ...
    def test_generate_character_empty_input(self, mock_creator_class, mock_factory_class, client, mock_complete_character):
        """Test character generation with empty input."""
        mock_creator_instance = _setup_mocks(mock_creator_class, mock_factory_class)
        ...
        expected_fields = {"name", "tagline", "backstory", "personality", "appearance", "interests", "dislikes"}
    ...
    @patch("src.fastapi_server.PromptProcessorFactory")
    @patch("src.fastapi_server.CharacterCreator")
    def test_generate_character_partial_input(self, mock_creator_class, mock_factory_class, client, mock_complete_character):
        ...
        generated_fields = data["generated_fields"]
        expected_generated = {"backstory", "personality", "appearance", "interests", "dislikes"}
    ...
    @patch("src.fastapi_server.PromptProcessorFactory")
    @patch("src.fastapi_server.CharacterCreator")
    def test_generate_character_with_interests_and_dislikes(self, mock_creator_class, mock_factory_class, client, mock_complete_character):
        """Test character generation with list fields provided."""
        mock_creator_instance = _setup_mocks(mock_creator_class, mock_factory_class)
        mock_creator_instance.generate.return_value = mock_complete_character

        partial_input = {"name": "Generated Hero", "interests": ["Cooking", "Reading"], "dislikes": ["Spiders"]}
        ...
        generated_fields = data["generated_fields"]
        expected_generated = {"tagline", "backstory", "personality", "appearance"}
        assert set(generated_fields) == expected_generated

        assert "interests" not in generated_fields
        assert "dislikes" not in generated_fields

    @patch("src.fastapi_server.PromptProcessorFactory")
    @patch("src.fastapi_server.CharacterCreator")
    def test_generate_character_validation_error(self, mock_creator_class, mock_factory_class, client):
    ...
    @patch("src.fastapi_server.PromptProcessorFactory")
    @patch("src.fastapi_server.CharacterCreator")
    def test_generate_character_server_error(self, mock_creator_class, mock_factory_class, client):
    ...
    @patch("src.fastapi_server.PromptProcessorFactory")
    @patch("src.fastapi_server.CharacterCreator")
    def test_generate_character_default_processor_type(self, mock_creator_class, mock_factory_class, client):
